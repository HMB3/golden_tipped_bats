---
title: "Habitat Suitability modelling for Golden Tipped Bats"
authors: "Hugh Burley, Brad Law, Chris"
date: "March 2020"
output:
  github_document:
  toc: true   
...
## Use the bat species
data("bat.spp")
analysis_spp <- str_trim(bat.spp)[1:2]
analysis_spp
...
without returning anything. The package functions expect these folders (a typical R project structure), create them if they don't exist
...
data sources are needed to properly quantify species ranges.
...
The original analysis used a template raster of 1km * 1km cells to filter 
...
distributions. This could be replaced with a finer resolution raster : 250m, etc.
...
and projection (Mollweide) as the analysis data. 
...
MAXENT.RESULTS = compile_sdm_results(species_list = analysis_spp[66],
